...
import { ArrowLeft, Clock, Users, MapPin, Shield, AlertTriangle, Sparkles, CheckCircle2, Mic, Image as ImageIcon, FileText, Send } from 'lucide-react'
...
export default function IncidentDetail() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-5">
      <Link to="/app" className="inline-flex items-center gap-1 text-sm text-ink-500 hover:text-brand-600"><ArrowLeft size={16}/> Back</Link>
      ...
      <div className="grid lg:grid-cols-[1.5fr_1fr] gap-5">
        <div className="space-y-5">
          ...
          <Card className="!p-0 overflow-hidden">
            <div className="p-5 border-b border-ink-200 dark:border-ink-800 font-bold flex items-center gap-2"><MapPin size={18}/> Location</div>
            <Map incidents={[inc]} height={350} zoom={16} center={[inc.lat,inc.lng]}/>
          </Card>
