...
function Loader(){return <div className="min-h-[50vh] grid place-items-center text-ink-400"><Spinner size={28}/></div>}

function pickHomeByRole(role) {
  // For roles that have their own agency dashboard, use that; responder gets incidents command center.
...
export default function App() {
  useTheme()
  const { user } = useAuth()
  // Navbar shown on every page for consistent theme/language toggles.
  return (
