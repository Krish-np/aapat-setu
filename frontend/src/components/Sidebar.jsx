        ...
        <div className="p-3 border-t border-ink-200/60 dark:border-ink-800/60 space-y-2 shrink-0">
          ...
          >
            ...
            <button
              ...
              title={
                i18n.language === "en"
                  ? "Switch to Nepali / नेपालीमा स्विच गर्नुहोस्"
                  : "Switch to English"
              }
              className="h-9 rounded-xl bg-ink-100 dark:bg-ink-800 p-1 flex items-center text-[11px] font-bold transition hover:bg-ink-200 dark:hover:bg-ink-700 shrink-0"
            >
              <span
