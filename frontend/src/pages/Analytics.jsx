...
const tooltipStyle = { background:'#0f172a', border:'1px solid rgba(255,255,255,0.06)', borderRadius:10, color:'#fff', fontSize:12, boxShadow:'0 8px 30px rgba(0,0,0,.35)' }
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <Card className="space-y-3"><Skeleton className="h-5 w-40"/><Skeleton className="h-72 w-full rounded-lg"/></Card>
        <Card className="space-y-3"><Skeleton className="h-5 w-44"/><Skeleton className="h-72 w-full rounded-lg"/></Card>
        <Card className="md:col-span-2 space-y-3"><Skeleton className="h-5 w-40"/><Skeleton className="h-64 w-full rounded-lg"/></Card>
      </div>
    </div>
  )
}
  ...
  return (
    <div>
      <PageHeader
        ...
        title={t('analytics.title','Intelligence Analytics')}
        subtitle={t('analytics.subtitle','Real-time emergency intelligence for decision makers')}
      />

      {!stats ? <AnalyticsSkeleton/> : (
        <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ duration:.4 }} className="space-y-5">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Card>
              <h3 className="font-semibold text-[15px] mb-3 text-ink-900 dark:text-white">{t('analytics.by_type','Incidents by Type')}</h3>
              <div className="h-72">
                <ResponsiveContainer>
            ...
            <Card>
              <h3 className="font-semibold text-[15px] mb-3 text-ink-900 dark:text-white">{t('analytics.by_severity','Incidents by Severity')}</h3>
              <div className="h-72">
                <ResponsiveContainer>
                  <PieChart>
            ...
            <Card className="md:col-span-2">
              <h3 className="font-semibold text-[15px] mb-3 text-ink-900 dark:text-white">{t('analytics.by_status','Status Breakdown')}</h3>
              <div className="h-64">
                <ResponsiveContainer>
